...
ConstantBuffer<DirectionalLightData> g_light : register(b0,space3);
StructuredBuffer<int> g_influences : register(t0,space3);
StructuredBuffer<float> g_weights : register(t1,space3);
StructuredBuffer<float4x4> g_matrices : register(t2,space3);
