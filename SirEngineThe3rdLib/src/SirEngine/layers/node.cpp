...
static void ShowExampleAppCustomNodeGraph(bool* opened)
{
    ...
    struct Node
    {
        ...
        Node(int id, const char* name, const ImVec2& pos, int inputs_count, int outputs_count) { ID = id; strncpy(Name, name, 31); Name[31] = 0; Pos = pos;  InputsCount = inputs_count; OutputsCount = outputs_count; }
    ...
    if (ImGui::BeginPopup("context_menu"))
    {
        ...
        {
            if (ImGui::MenuItem("Add")) { nodes.push_back(Node(nodes.Size, "New node", scene_pos,  2, 2)); }
